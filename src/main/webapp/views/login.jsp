...
<jsp:include page="common/header.jsp">
    <jsp:param name="title" value="Đăng Nhập - MVC 3 Tier" />
</jsp:include>
<body>
                ...
                <form action="${pageContext.request.contextPath}/login" method="post">
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="username" value="${param.username}" placeholder="Nhập username (vd: admin, trungnh)" required autofocus />
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="password" class="form-control" name="password" placeholder="Nhập mật khẩu (vd: 123 hoặc 123456)" required />
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="rememberMe">Nhớ tài khoản (Remember Me Cookie)</label>
                        </div>
                    ...
                    <div class="text-center mt-4">
                        ...
                        <p class="mt-2"><a href="${pageContext.request.contextPath}/" class="text-secondary small"><i class="fa fa-home"></i> Quay lại trang chủ portal</a></p>
                    </div>
                </form>
            </div>
        </div>
